...
KUERZEL_POS = [
    ...
    ("ZBR", "*8000", 0, 1, "fix", "privat"),
    ("ZBR", "9330", 0, 1, "fix", "kasse"),
    ("ZBR", "*9022", 0, 1, "fix", None),
    ("ZBR", "*9025", 0, 2, "fix", None),
    ("ZBR", "*0201", 0, 1, "fix", None),
    ("ZBR", "*0202", 0, 1, "fix", "gesichtsbogen"),

    # ─── ZB — Zirkon-Brückenglied vollanatomisch (UNVERBLENDET) ──────────
    # Wie ZBR, aber:
    #   - *3002 statt *3000 (vollanatomisch statt zur Verblendung)
    #   - KEIN *5500 (keine Verblendung)
    ("ZB", "*0001", 1, 1, "fix", None),
    ("ZB", "*0301", 1, 1, "fix", None),
    ("ZB", "*3002", 1, 1, "pro_zahn", None),
    ("ZB", "*5504", 1, 1, "pro_zahn", None),
    ("ZB", "*5601", 1, 1, "pro_zahn", None),
    ("ZB", "*5602", 1, 1, "pro_zahn", None),
    ("ZB", "*5603", 1, 1, "pro_zahn", None),
    ("ZB", "*5604", 1, 1, "pro_zahn", None),
    ("ZB", "*Z100", 1, 1, "pro_zahn", None),
    ("ZB", "*I614", 0, 1, "pro_zahn", None),
    ("ZB", "*0600", 0, 1, "pro_zahn", None),
    ("ZB", "*8000", 0, 1, "fix", "privat"),
    ("ZB", "9330", 0, 1, "fix", "kasse"),
    ("ZB", "*9022", 0, 1, "fix", None),
    ("ZB", "*9025", 0, 2, "fix", None),
    ("ZB", "*0201", 0, 1, "fix", None),
    ("ZB", "*0202", 0, 1, "fix", "gesichtsbogen"),
    ("ZB", "*0051", 0, 1, "fix", None),
