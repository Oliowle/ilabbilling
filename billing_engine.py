...
KUERZEL_POS = [
    ...
    ("ZK", "*8000", 0, 2, "fix", None),
    ("ZK", "9330", 0, 2, "fix", None),
    ...
    ("ZKV", "*8000", 0, 2, "fix", None),
    ("ZKV", "*0012", 0, 1, "fix", None),
    ("ZKV", "*5502", 0, 1, "fix", None),
    ("ZKV", "9330", 0, 2, "fix", None),
    ...
    ("ZBR", "*3002", 0, 1, "pro_zahn", None),
    ("ZBR", "*3003", 0, 1, "pro_zahn", None),
    ...
    ("MOCK", "*8000", 0, 2, "fix", None),
    ("MOCK", "9330", 0, 2, "fix", None),
    ...
    ("ZKAP", "*8000", 0, 2, "fix", None),
    ("ZKAP", "9330", 0, 2, "fix", None),
]
